...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","𓆪𓆩ᚐнανσ¢ вєαѕтᚐ")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Heer_xbot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Avinashbabuu/sara",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Nepsxbot")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Friend_Forever_Groups")
